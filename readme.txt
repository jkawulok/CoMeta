========================================================= Classification of metagenomes - CoMeta ========================================================
CoMeta (Classification of metagenomes) is a tool used to assign a query read (a DNA fragment) from metagenomic sample into one of 
the groups previously prepared by the user. Typically, this is one of the taxonomic rank (e.g., phylum, genus), however prepared groups may contain 
sequences having various functions.
...
D -	Selection of CoMeta parameters



*******************************************************************************************************************************************************
A.	Preparation of the working environment: Installation, download files and programs, 
	adding the taxonomic id (tax number) to the reference sequence
